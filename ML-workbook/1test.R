...
https://raw.githubusercontent.com/waliurmeraz/mltraining/master/ML-workbook/train.csv

train <- read.csv('https://raw.githubusercontent.com/waliurmeraz/mltraining/master/ML-workbook/train.csv')
